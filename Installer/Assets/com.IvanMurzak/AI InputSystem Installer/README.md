...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.inputsystem/package.json`
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.inputsystem` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.inputsystem` as well.
