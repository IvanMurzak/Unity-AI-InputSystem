...
namespace com.IvanMurzak.Unity.MCP.InputSystem.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI InputSystem Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI InputSystem Installer/Tests/Files";
