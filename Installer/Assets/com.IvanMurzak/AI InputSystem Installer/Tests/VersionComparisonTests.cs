...
using com.IvanMurzak.Unity.MCP.InputSystem.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.InputSystem.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.InputSystem.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.inputsystem";
