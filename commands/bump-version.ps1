...
$VersionFiles = @(
    @{
        Path        = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.inputsystem/package.json"
        Pattern     = '"version":\s*"[\d\.]+"'
        Replace     = '"version": "{VERSION}"'
        Description = "Unity package version"
    },
    @{
        Path        = "Installer/Assets/com.IvanMurzak/AI InputSystem Installer/Installer.cs"
...
function Get-CurrentVersion {
    ...
    $packageJsonPath = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.inputsystem/package.json"
