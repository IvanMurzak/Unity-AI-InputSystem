...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.inputsystem/package.json`
...
<details>
  ...
  - 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.inputsystem/Tests` folder
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.inputsystem/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.inputsystem/Tests/Base/Package.Tests.asmdef`
